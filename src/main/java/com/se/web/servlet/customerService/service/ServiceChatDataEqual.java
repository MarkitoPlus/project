...
@WebServlet("/api/service/chat/get/equal")
public class ServiceChatDataEqual extends HttpServlet{
  @Override
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    // 查客服的聊天记录
    List<ChatRes> chats = ServiceUtil.getChatListInRule(service, type, ServiceUtil.SearchRule.EQUAL, value);
